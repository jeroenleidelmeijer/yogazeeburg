...
describe("Yoga Gids — legacy regression (articles 1–3)", () => {
  const legacy = listLegacyRefs();

  it("exposes exactly the three seeded legacy articles", () => {
  ...
  it("marks all three as legacy source with searchable text", () => {
