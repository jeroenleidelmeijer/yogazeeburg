  ...
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        ...
        { name: "robots", content: hasArticles ? "index, follow" : "noindex, follow" },
        {
          name: "description",
          content: hasArticles
        ...
        ...(hasArticles ? [{ property: "og:url", content: CANONICAL }] : []),
      ],
      ...
      <main className="flex-1">
        <section className="border-b border-border/60 bg-secondary/30">
          <div className="mx-auto max-w-4xl px-4 py-14 text-center sm:px-6 md:py-16 lg:px-8">
            ...
            <h1 className="mt-3 font-display text-4xl font-medium tracking-tight text-foreground sm:text-5xl">Alle artikelen</h1>
            <p className="mx-auto mt-5 max-w-xl text-muted-foreground">Alle gepubliceerde artikelen in de Yoga Gids, met de nieuwste bovenaan.</p>
          </div>
        </section>
        <section className="mx-auto max-w-5xl px-4 py-12 sm:px-6 md:py-16 lg:px-8">
          {articles.length > 0 ? (
            ...
            <div className="rounded-2xl border border-dashed border-border bg-card/70 p-8 text-center">
              <p className="text-foreground">Nog geen artikelen gepubliceerd.</p>
              <p className="mt-2 text-sm text-muted-foreground">Kom binnenkort terug voor de eerste praktische gidsen.</p>
            </div>
          )}
        </section>
      </main>
