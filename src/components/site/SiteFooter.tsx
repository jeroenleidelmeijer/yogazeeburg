    ...
    <footer className="border-t border-border/60 bg-secondary/60">
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-14 sm:px-6 lg:grid-cols-3 lg:px-8">
        <div>
          ...
          <p className="mt-3 text-xs text-muted-foreground">Amsterdam East · Zeeburg · Cruquius</p>
          <a
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm">
            ...
            <li>
              <Link to="/sportbit" className="text-muted-foreground hover:text-foreground">
                Sportbit guide
              </Link>
            </li>
            <li>
